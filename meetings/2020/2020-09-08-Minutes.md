...
2. **ACTION all**: Individuals from this group not associated with drafting the [SCID WG output document](https://www.rd-alliance.org/group/rdaforce11-software-source-code-identification-wg/outcomes/scid-wg-output-use-cases-and), please comment if you have time. _**DONE**_
