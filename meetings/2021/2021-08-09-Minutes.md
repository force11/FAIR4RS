...
Subgroup 7 has one lead, if anyone else would like to co-lead with Tom Honeyman. Qian Zhang volunteered.
...
Subgroup's names updated from 1-2 to 5-7.
...
**Next Meeting**: Monday, September 13th 20:00 UTC (_**chair**_: Fotis Psomopoulos, _**note taker**_: Carlos Martinez). For invitation see events on the [FAIR4RS WG events](https://www.rd-alliance.org/node/69317/events)
