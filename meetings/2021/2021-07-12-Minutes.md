...
2. During the first week on June 16th. It was updated from an RDA output to a RDA recommendation, which needs to be supported by early adopters (next point in the agenda). Potential adopters that have been contacted are:
  ...
  4. ZB MED
3. We requested to add the Steering Committee as chairs
...
- Some larger scope comments: e.g. services, preservation that need working group discussion
...
Question: Are we looking to create the equivalent of having definition plus explanation text (similarly to the GOFair website)?.
...
2. The principles along with very high level guidance for adoption (similar to what is on the GOFAIR website for the FAIR Data Principles)
...
At this point, the current draft of the FAIR4RS Principles is a combination of 1, with some aspects of 2 and 3 for some principles, along with explanatory text on how to interpret - but not adopt - the principles.
...
Star first with the top 3 options (in that order): Nature/Nature Data, Data Science, F1000
...
Number 3 might be what it is the current suggestion for adoption guidelines
...
We also need to define when this subgroups will start (July/August are not optimal months for starting new activities)
...
**5. Past and Future activities short updates (10 min)**
  ...
  7. July 20-22 [Collegeville](https://collegeville.github.io/CW21/) (Dan) - whitepaper submitted
...
**Next Meeting** : Monday, August 09th 20:00 UTC (_ **chair** _: Daniel S. Katz, _ **note taker** _: Paula A. Martinez). For invitation see events on the [FAIR4RS WG events](https://www.rd-alliance.org/node/69317/events)
